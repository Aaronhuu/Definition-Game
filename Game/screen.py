...
bg1 = pygame.image.load(getAbsoluteResourcePath('data/bg1.jpg'))
blurbg= pygame.image.load(getAbsoluteResourcePath('data/blurbg.jpg'))
bg2 = pygame.image.load(getAbsoluteResourcePath('data/space.jpg'))
bg3 = pygame.image.load(getAbsoluteResourcePath('data/bg3.jpg'))
icon= pygame.image.load(getAbsoluteResourcePath('data/icon.png'))
leftwing = pygame.image.load(getAbsoluteResourcePath('data/leftwing.png'))
rightwing = pygame.image.load(getAbsoluteResourcePath('data/rightwing.png'))
pythonlogo = pygame.image.load(getAbsoluteResourcePath('data/Python.png'))
pygamelogo = pygame.image.load(getAbsoluteResourcePath('data/pygame_logo.png'))
